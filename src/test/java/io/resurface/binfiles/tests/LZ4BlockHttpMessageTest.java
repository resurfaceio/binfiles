...
/**
 * Tests against LZ4 block-compressed binary format for HTTP messages.
 */
public class LZ4BlockHttpMessageTest {

    public final String FILE = "./target/message-v31.blk.lz4b";
    ...
    public void roundTripTest() throws Exception {
        try (FileOutputStream fo = new FileOutputStream(FILE)) {
            try (LZ4BlockOutputStream bos = new LZ4BlockOutputStream(fo)) {
        ...
        try (FileInputStream fi = new FileInputStream(FILE)) {
            try (LZ4BlockInputStream bis = new LZ4BlockInputStream(fi)) {
                BinaryHttpMessage m = new BinaryHttpMessage();
                m.read(bis);
