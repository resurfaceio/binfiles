...
observability and security. This binary format is specifically designed for fast queries from Trino, including the use of
...
* Java 11
* Airlift slice (not included)
* lz4-java (not included)
